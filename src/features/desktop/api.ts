...
const defaultSettings = {
  ...
  opencodePath: null,
  zcodePath: null,
  chat2dbLocalHome: null,
  chat2dbCommunityHome: null,
  chat2dbProHome: null,
  kiroHome: null,
  kiroIdeHome: null,
  geminiHome: null,
  ...
  visiblePlatforms: ["claude", "codex", "cursor", "opencode", "zcode", "chat2db-local", "chat2db-community", "chat2db-pro", "grok", "pi"] as string[],
  navigationItems: [
    "claude",
    "codex",
    "terminal-sessions",
